...
const navItems = [
  {
    path: '/',
    name: 'Overview',
    caption: 'Live pulse and command summary',
    icon: (
  ...
  },
  {
    path: '/map',
    name: 'Risk Map',
    caption: 'Spatial predictions and watchlist',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    path: '/historical',
    name: 'History Lab',
    caption: 'Trend analysis and incident review',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    path: '/alerts',
    name: 'Alerts',
    caption: 'Unread items and response queue',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  },
  {
    path: '/profile',
    name: 'Profile',
    caption: 'Thresholds and operator settings',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="panel rounded-[1.8rem] p-5">
          ...
          <div className="mt-4 space-y-3">
            {savedRegions.length === 0 ? (
              <p className="text-sm text-stone-400">Save a region from the map to build a quick-access watchlist.</p>
            ) : (
